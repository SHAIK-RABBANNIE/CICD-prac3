pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://18.234.115.49:8021/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/SHAIK-RABBANNIE/CICD-prac3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://18.234.115.49:8021/springapp1"
            echo "✅ Frontend deployed: http://18.234.115.49:8021/frontapp1"
        }
        failure {
